...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 71 9.8720-2769",
      link: "https://wa.me/5571987202769?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "ph.jesus@gmail.com",
      link: "mailto:ph.jesus@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Salvador-BA ",
      description: "Cabula",
      link: "https://goo.gl/maps/zZ4NtJ5haLnfSuVv6",
