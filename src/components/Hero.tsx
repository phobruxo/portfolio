      ...
      <section className="rounded-br-[80px] bg-gradient-to-tr from-black to-gray-900 text-white md:rounded-br-[180px]">
        <div className="container mx-auto flex max-w-4xl flex-col-reverse p-4 py-12 md:flex-row">
          <div className="basis-1/2">
            ...
            Desenvolvedor Front-End Junior com habilidades excepcionais busca oportunidades
             para impulsionar projetos web de forma criativa e inovadora e com conhecimento  também em Node.js
            </p>
            ...
            <div className="flex items-center justify-center gap-2 md:justify-start">
              ...
              <a
                href="https://1drv.ms/b/s!Apzeh4eBIIi5gflh-Lfm17y7MHz4eg?e=ZRsmgI"
                target="_blank"
